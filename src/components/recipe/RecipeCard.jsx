  ...
  return (
    <div className="card card-hover bg-white dark:bg-gray-800 shadow-md overflow-hidden">
      ...
      <div className="card-body p-4">
        <h2 className="card-title text-xl font-bold text-gray-900 dark:text-white mb-2">{recipe.title}</h2>
        ...
        <div className="card-actions">
          <Link to={`/recipe/${recipe.id}`} className="btn btn-primary btn-sm w-full">
            View Details
          </Link>
        </div>
      </div>
