...
const MyRecipes = () => {
  ...
  useEffect(() => {
    ...
    const userRecipes = dummyRecipes.filter(recipe => recipe.userId === user.uid)
      ...
      <div className="container">
        ...
        {myRecipes.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
            <p className="text-gray-600 dark:text-gray-400 mb-4">You haven't added any recipes yet.</p>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-2/3 p-6">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-4">
                      ...
                      <span className="badge badge-outline">{recipe.preparationTime} min</span>
                      <span className="badge badge-outline">{recipe.likeCount} likes</span>
                    </div>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {recipe.categories.map(category => (
                          <span key={category} className="badge badge-primary badge-outline">
                            {category}
                          </span>
                        ))}
                      </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <RecipeForm 
                  ...
                  buttonText={isSubmitting ? 'Updating Recipe...' : 'Update Recipe'}
                />
              </div>
            </div>
          </div>
