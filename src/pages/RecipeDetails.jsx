          ...
          <div className="relative h-64 md:h-96">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              <div className="flex items-center gap-4 mb-2">
                <span className="badge badge-primary">{recipe.cuisineType}</span>
                {recipe.categories.map(category => (
                  <span key={category} className="badge badge-outline text-white">
                    {category}
                  </span>
                ))}
              </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    {recipe.likeCount} {recipe.likeCount === 1 ? 'person is' : 'people are'} interested in this recipe
                  </span>
                </div>
              </div>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                This {recipe.cuisineType} dish takes approximately {recipe.preparationTime} minutes to prepare 
                and is perfect for {recipe.categories.join(', ')}. 
                With {recipe.ingredients.length} ingredients and {recipe.instructions.length} easy-to-follow steps, 
                it's a {recipe.likeCount > 100 ? 'popular' : 'delicious'} choice for your next meal.
              </p>
            </div>
          </div>
        </div>
